...
#wget https://cloud-images.ubuntu.com/focal/20230731/focal-server-cloudimg-amd64.img  
sleep 7
qemu-img create -b /mnt/focal-server-cloudimg-amd64.img   -f qcow2 -F qcow2 /mnt/focal-server-cloudimg.qcow2 45G
cloud-localds -v --network-config=network_ubuntu.cfg /mnt/test1-seed.img cloud_init.cfg
sleep 10
...
cloud-localds -v --network-config=network_ubuntu2.cfg /mnt/test1-seed.img cloud_init.cfg
sleep 10
...
cloud-localds -v --network-config=network_ubuntu3.cfg /mnt/test1-seed.img cloud_init.cfg
sleep 10
